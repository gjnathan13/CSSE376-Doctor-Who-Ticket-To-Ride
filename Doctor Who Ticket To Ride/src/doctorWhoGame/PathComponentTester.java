...
public class PathComponentTester {
	...
	@Test
	public void TestPositiveShiftOnPathWithPositiveSlope()
			throws NoSuchMethodException, SecurityException,
			IllegalAccessException, IllegalArgumentException,
			InvocationTargetException {
		Class[] parameters = { Point2D.class, Point2D.class, int.class };
		PathComponent mockPathComponent = EasyMock
				.createMock(PathComponent.class);
		Method shiftLineMethod = PathComponent.class.getDeclaredMethod(
				"getShiftedLine", parameters);
		...
		Line2D.Double shiftedLine = (Line2D.Double) shiftLineMethod.invoke(
				mockPathComponent, inputs);
	...
	@Test
	public void TestPositiveShiftOnPathWithPNegativeSlope()
			throws NoSuchMethodException, SecurityException,
			IllegalAccessException, IllegalArgumentException,
			InvocationTargetException {
		Class[] parameters = { Point2D.class, Point2D.class, int.class };
